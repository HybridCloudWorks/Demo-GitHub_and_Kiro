...
[`labs/l3/`](https://github.com/HybridCloudWorks/Demo-GitHub_and_Kiro/tree/main/labs/l3). In a copy
...
[`project/`](https://github.com/HybridCloudWorks/Demo-GitHub_and_Kiro/tree/main/project) via a pull
